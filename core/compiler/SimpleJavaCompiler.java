...
public class SimpleJavaCompiler {
    ...
    /**
     * Compiles and class-loads a single class from the specified Java source
     * code.To amortize the cost of initializing a JavaCompiler, underlying
     * instances are cached on a per-thread basis.It is recommended that callers
     * of this method reuse threads for increased performance and reduced memory
     * consumption.
     *
     * @param <T> .
     ...
     * @param <T> ...
     * @param superClass ...
     * @param sourceGen a String containing Java source code to generate the
     * class
     * @return the compiled and class-loaded class
     */
