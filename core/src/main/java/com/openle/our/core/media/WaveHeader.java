//  https://github.com/JorenSix/TarsosDSP/blob/master/core/src/main/java/be/tarsos/dsp/writer/WaveHeader.java
//  用法 - https://github.com/JorenSix/TarsosDSP/blob/master/core/src/main/java/be/tarsos/dsp/writer/WriterProcessor.java
/*
                var wh = new WaveHeader(WaveHeader.FORMAT_PCM,
                        (short) audioFormat.getChannels(),
                        (int) audioFormat.getSampleRate(), (short) 16, bytes.length);
                var hBytes = new ByteArrayOutputStream();
                wh.write(hBytes);
                hBytes.write(bytes);
                var r = hBytes.toByteArray();
 */
package com.openle.our.core.media;
 ...
 * https://android.googlesource.com/platform/frameworks/base.git/+/android-4.3_r2/core/java/android/speech/srec/WaveHeader.java
 */
/**
...
public class WaveHeader {
     ...
     *
     * @param format format of audio data, one of
     * {@link #FORMAT_PCM}, {@link #FORMAT_ULAW}, or {@link #FORMAT_ALAW}.
     ...
     *
     * @return format field, one of {@link #FORMAT_PCM}, {@link #FORMAT_ULAW},
     * or {@link #FORMAT_ALAW}.
     */
     ...
     *
     * @param format one of {@link #FORMAT_PCM}, {@link #FORMAT_ULAW}, or
     * {@link #FORMAT_ALAW}.
     ...
     * Set the sample rate.
     *
     * @param sampleRate sample rate, typically 8000, 11025, 16000, 22050, or
     * 44100 hz.
     * @return reference to this WaveHeader instance.
     */
     ...
     *
     * @return number of bits per sample, usually 16 for PCM, 8 for ULAW or 8
     * for ALAW.
     */
     ...
     *
     * @param bitsPerSample number of bits per sample, usually 16 for PCM, 8 for
     * ULAW or 8 for ALAW.
     * @return reference to this WaveHeader instance.
     */
