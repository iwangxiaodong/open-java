...
/**
 * Copyright (c) 2013 ooxi https://github.com/ooxi/jdatauri
 *
...
import com.openle.our.core.patch.android.Base64;
...
public class DataUri {
    ...
    public static DataUri parse(String uri, Charset charset) {
        ...
        final byte[] finalData = "base64".equalsIgnoreCase(contentEncoding)
                ...
                ? Base64.decode(data, Base64.NO_WRAP) : data.getBytes(charset);
    ...
    public String toString() {
        ...
        s.append("base64,").append(Base64.encodeToString(this.getData(), Base64.NO_WRAP));
